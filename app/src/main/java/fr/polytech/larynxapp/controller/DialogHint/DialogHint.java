...
public class DialogHint extends AppCompatActivity {
    ...
    private void loadCards() {
        ...
        modelArrayList.add(new DialogModel("1 - Bienvenue", "Ce tutoriel permet de comprendre le fonctionnement de LarynxApp.\nLarynxApp est une application permettant l'analyse de votre voix.\nCes analyses peuvent permettre d'aider votre médecin.", R.drawable.capture1));
        modelArrayList.add(new DialogModel("2 - Enregistrement", "L'enregistrement est la première étape pour analyser votre voix et en même temps la plus importante, essayez d'être au maximum dans un endroit isolé et calme pour vous enregistrer. Des indications sont affichées tout le long de l'enregistrement pour vous aiguiller.", R.drawable.capture2));
        modelArrayList.add(new DialogModel("2 - Enregistrement", "Afin d'avoir un enregistrement précis, placez-vous à environ 20cm de votre microphone et evitez de vous en eloigner pendant l'enregistrement. Prononcez un 'ah' prolongé tout le long de l'enregistrement.", R.drawable.capture21));
        modelArrayList.add(new DialogModel("2 - Enregistrement", "Une fois l'enregistrement terminé vous pouvez le recommencer ou le sauvegarder. Vous retrouverez alors cet enregistrement dans vos résultats et dans l'onglet 'Historique'.", R.drawable.capture22));
        modelArrayList.add(new DialogModel("3 - Historique", "Cet onglet permet de voir tous les enregsitrements que vous avez réalisés et d'en avoir les détails. En appuyant simplement sur un enregistrement vous verrez alors un récapitulatif des résultats ainsi que leur signification. Un appui prolongé vous permettra de le supprimer.", R.drawable.capture3));
        modelArrayList.add(new DialogModel("4 - Analyse Shimmer", "L'onglet d'analyse Shimmer affiche un graphique de l'évolution de la variable Shimmer de tous vos enregistrements. Vous pourrez alors voir l'évolution de votre voix sous ce paramètre. Cet onglet permet égalemennt de sélectionner une période à afficher sur le graphique.", R.drawable.capture4));
        modelArrayList.add(new DialogModel("5 - Analyse Jitter", "L'onglet d'analyse Jitter affiche un graphique de l'évolution de la variable Jhimmer de tous vos enregistrements. Vous pourrez alors voir l'évolution de votre voix sous ce paramètre. Cet onglet permet égalemennt de sélectionner une période à afficher sur le graphique.", R.drawable.capture5));
